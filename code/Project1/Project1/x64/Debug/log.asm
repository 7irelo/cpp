...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?log@@YAXH@Z DD imagerel $LN3
	DD	imagerel $LN3+75
	DD	imagerel $unwind$?log@@YAXH@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?log@@YAXH@Z DD 025051201H
	DD	010d2312H
	DD	07006001dH
	DD	05005H
xdata	ENDS
...
; File C:\Users\Eric\Documents\Coding\c++\Project1\log.cpp
; Line 9
$LN3:
	mov	QWORD PTR [rsp+8], rcx
	push	rbp
	...
	sub	rsp, 232				; 000000e8H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__E276C6BA_log@cpp
	call	__CheckForDebuggerJustMyCode
; Line 10
	mov	rdx, QWORD PTR hash$[rbp]

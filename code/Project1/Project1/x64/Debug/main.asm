...
PUBLIC	?SetLevel@Log@@QEAAXW4Level@1@@Z		; Log::SetLevel
PUBLIC	?Warning@Log@@QEAAXPEBD@Z			; Log::Warning
...
PUBLIC	??_C@_0M@CIAJGPA@?$FLWARNING?$FN?3?5@		; `string'
PUBLIC	??_C@_0EP@HJGIHNAF@Malware?5was?5detected?5in?5your?5sy@ ; `string'
EXTRN	strlen:PROC
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?SetLevel@Log@@QEAAXW4Level@1@@Z DD imagerel $LN3
	DD	imagerel $LN3+60
	DD	imagerel $unwind$?SetLevel@Log@@QEAAXW4Level@1@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$?Warning@Log@@QEAAXPEBD@Z DD imagerel $LN4
	DD	imagerel $LN4+108
	DD	imagerel $unwind$?Warning@Log@@QEAAXPEBD@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$??0Log@@QEAA@XZ DD imagerel $LN4
	DD	imagerel $LN4+47
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0EP@HJGIHNAF@Malware?5was?5detected?5in?5your?5sy@
CONST	SEGMENT
??_C@_0EP@HJGIHNAF@Malware?5was?5detected?5in?5your?5sy@ DB 'Malware was '
	DB	'detected in your system. Reboot immediately. Red Alert. Red A'
	DB	'lert!', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@CIAJGPA@?$FLWARNING?$FN?3?5@
CONST	SEGMENT
??_C@_0M@CIAJGPA@?$FLWARNING?$FN?3?5@ DB '[WARNING]: ', 00H ; `string'
CONST	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??0Log@@QEAA@XZ DD 05051101H
	DD	010e0311H
	DD	070070019H
	DD	05006H
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$?Warning@Log@@QEAAXPEBD@Z DD 025051801H
	DD	01132318H
	DD	0700c001dH
	DD	0500bH
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$?SetLevel@Log@@QEAAXW4Level@1@@Z DD 025051701H
	DD	01122317H
	DD	0700b001dH
	DD	0500aH
xdata	ENDS
...
__$ArrayPad$ = 216
main	PROC						; COMDAT
; File C:\Users\Eric\Documents\Coding\c++\Project1\main.cpp
; Line 36
$LN3:
	push	rbp
	push	rdi
	...
	lea	rcx, OFFSET FLAT:__F221825B_main@cpp
	call	__CheckForDebuggerJustMyCode
; Line 37
...
; Line 38
	mov	edx, 1
	lea	rcx, QWORD PTR log$[rbp]
	call	?SetLevel@Log@@QEAAXW4Level@1@@Z	; Log::SetLevel
; Line 39
	lea	rdx, OFFSET FLAT:??_C@_0EP@HJGIHNAF@Malware?5was?5detected?5in?5your?5sy@
	lea	rcx, QWORD PTR log$[rbp]
	call	?Warning@Log@@QEAAXPEBD@Z		; Log::Warning
; Line 40
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?Warning@Log@@QEAAXPEBD@Z
_TEXT	SEGMENT
this$ = 224
message$ = 232
?Warning@Log@@QEAAXPEBD@Z PROC				; Log::Warning, COMDAT
; File C:\Users\Eric\Documents\Coding\c++\Project1\main.cpp
; Line 24
$LN4:
	mov	QWORD PTR [rsp+16], rdx
...
; Line 25
	mov	rax, QWORD PTR this$[rbp]
	cmp	DWORD PTR [rax], 1
	jl	SHORT $LN2@Warning
; Line 26
	lea	rdx, OFFSET FLAT:??_C@_0M@CIAJGPA@?$FLWARNING?$FN?3?5@
...
; Line 27
	...
	pop	rbp
	ret	0
?Warning@Log@@QEAAXPEBD@Z ENDP				; Log::Warning
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?SetLevel@Log@@QEAAXW4Level@1@@Z
_TEXT	SEGMENT
this$ = 224
level$ = 232
?SetLevel@Log@@QEAAXW4Level@1@@Z PROC			; Log::SetLevel, COMDAT
; File C:\Users\Eric\Documents\Coding\c++\Project1\main.cpp
; Line 14
$LN3:
...
; Line 16
	...
	pop	rbp
	ret	0
?SetLevel@Log@@QEAAXW4Level@1@@Z ENDP			; Log::SetLevel
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI

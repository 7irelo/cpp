...
__8EC8CC17_header@h DB 01H
__99553DF4_multiply@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	?multiply@@YAXHH@Z				; multiply
...
PUBLIC	??_C@_03LBOPJCJH@?5x?5@				; `string'
EXTRN	strlen:PROC
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?multiply@@YAXHH@Z DD imagerel $LN3
	DD	imagerel $LN3+128
	DD	imagerel $unwind$?multiply@@YAXHH@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_03LBOPJCJH@?5x?5@
CONST	SEGMENT
??_C@_03LBOPJCJH@?5x?5@ DB ' x ', 00H			; `string'
CONST	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?multiply@@YAXHH@Z DD 025051601H
	DD	01112316H
	DD	0700a001dH
	DD	05009H
xdata	ENDS
...
text$x	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?multiply@@YAXHH@Z
_TEXT	SEGMENT
a$ = 224
b$ = 232
?multiply@@YAXHH@Z PROC					; multiply, COMDAT
; File C:\Users\Eric\Documents\Coding\c++\Project1\multiply.cpp
; Line 5
$LN3:
...
; Line 8
	...
	pop	rbp
	ret	0
?multiply@@YAXHH@Z ENDP					; multiply
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
